...
<div class="flex items-center border p-4 border-black mt-4 rounded-lg shadow-lg dark:border-white">
    <!-- Left Column - Text -->
    <div class="p-4 ">
        <div class="text-align">
            <h2 class="text-lg text-black md:text-2xl font-bold dark:text-gray-200">Halo, {{ auth()->user()->name }} !</h2>
            <p class="text-base text-black dark:text-gray-200">Temukan materi pelajaran, jadwal latihan, dan evaluasi untuk mendukung
                perjalanan
...
<div class="text-black">
    <div class="py-3">
        <div class="text-2xl font-bold px-0 py-2 dark:text-gray-200">Tingkatan Sabuk Saat Ini</div>
...
<div class="text-black py-2 mt-2">
    <h2 class="text-2xl font-bold mb-4 text-left dark:text-gray-200">Baru Saja Diakses</h2>
    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
        <!-- Course 1 -->
        <div class="bg-gray-200 dark:bg-gray-500 rounded-lg shadow-md flex overflow-hidden h-48 md:h-40">
...
<!--jadwal-->
<div class="text-black py-2 mt-2 dark:text-gray-200">
    <h2 class="text-2xl font-bold mb-4 text-left">Jadwal Saya Hari Ini</h2>
</div>

<div class="overflow-x-auto relative shadow-md rounded-md bg-gray-200 dark:bg-gray-600 dark:text-whit">
    <table class="w-full text-sm text-left text-black">
        ...
        <tbody>
            ...
            <tr class="bg-white border-b shadow-md dark:bg-gray-300">
                <td class="py-4 px-6">
