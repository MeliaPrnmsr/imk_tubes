    ...
    <div class="grid md:grid-cols-3 gap-4 mt-8">
                ...
                @foreach ($upcomingEvents as $event)
                    <li class="drop-shadow-md">
                        <div class="border p-2 bg-white my-3 rounded-lg">
                            ...
                            <p class="font-semibold">{{ $event->nama_informasi }}</p>
                            <p class="font-light text-sm">{{ $event->tanggal_informasi }}</p>
        ...
        <div class="border-2 rounded-lg p-1 md:p-4 mt-4 md:mt-0  bg-gray-200 shadow-xl">
            ...
            <ul class="m-2">
                <li class="drop-shadow-md">
                    <div class="border p-2 bg-white my-3 rounded-lg">
                        <p class="font-semibold">Pendaftaran Satu</p>
                        <p class="font-light text-sm">2024-10-20</p>
                    </div>
                </li>
                <li class="drop-shadow-md">
                    <div class="border p-2 bg-white my-3 rounded-lg">
                        <p class="font-semibold">Pendaftaran Dua</p>
                        <p class="font-light text-sm">2024-12-01</p>
                    </div>
                </li>
                <li class="drop-shadow-md">
                    <div class="border p-2 bg-white my-3 rounded-lg">
                        <p class="font-semibold">Pendaftaran Tiga</p>
                        <p class="font-light text-sm">2024-12-10</p>
                    </div>
                </li>
            </ul>
        </div>
