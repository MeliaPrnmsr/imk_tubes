...
<div class="mt-2 mb-4 md:mb-8 md:mt-4 flex justify-between items-center">
    ...
    <a href="/admin/tambahpelatih" class="bg-red-700 p-1 text-sm md:p-4 md:text-base rounded-lg text-white">Tambah
        Data</a>
</div>
@if (session('success'))
                ...
                <table class="min-w-full">
                    <thead>
                        <tr class="bg-red-700 text-white">
                            ...
                            <th scope="col" class="px-6 py-3 text-start text-xs md:text-base font-medium">Pengcab </th>
                        ...
                        <tr>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-center text-sm font-medium">
                                <a href="/admin/detailpelatih/{{ $item->kode_pelatih }}">
                                    <button type="button" class="inline-flex p-2 items-center justify-center gap-x-2 text-sm font-semibold rounded-lg border border-gray-200 hover:bg-gray-200 md:w-3/5">Detail</button>
                                </a>
                            </td>
                        </tr>
                        @endforeach
