        ...
        <form action="">
            ...
            <div class="grid md:grid-cols-2 gap-6 p-6">
                ...
                <div>
                    ...
                    <input readonly type="text" id="dojo"  class="py-3 px-4 w-full border border-gray-300 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none "
                        value="
                ...
                <div>
                    ...
                    <textarea readonly rows="3" id="alamat" class="py-3 px-4 w-full border border-gray-300 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none "> {{ $pelatih->Alamat }}</textarea>
                </div>
            ...
            <div class="flex justify-center">
                <button class="bg-red-700 p-3 m-2 rounded-lg text-white md:w-1/5 text-sm">
                    <a href="{{ route('edit.pelatih', ['id' => $pelatih->kode_pelatih]) }}"
