...
<body class="font-poppins">
        ...
        <div class="px-3 py-3 lg:px-5 lg:pl-3">
            <div class="flex items-center justify-between">
                ...
                <div class="flex items-center ">
                    {{-- ICON --}}
                    <a href="#" class="flex text-black text-sm border-black border rounded-md p-1 mx-1">
    ...
    <aside id="logo-sidebar"
        class="fixed top-0 left-0 z-40 w-18 h-screen pt-24 bg-white border-r border-black text-black flex-shrink-0 transition-all"
        aria-label="Sidebar">
