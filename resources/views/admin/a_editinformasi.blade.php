...
@section('content')
    <div class="mt-2 mb-4 md:mb-8 md:mt-4 items-center text-center">
        ...
        <h1 class="font-bold text-xl md:text-3xl md:font-bold">Edit Informasi</h1>
    </div>
    ...
    <div class="w-full">
        <form action="{{ route('edit.informasi2', ['id' => $informasi->kode_informasi]) }}" method="POST"
            ...
            <div class="grid md:grid-cols-2 gap-6 p-6">
                ...
                <div>
                    ...
                    <textarea rows="3" id="deskripsi_informasi" name="deskripsi_informasi"
                        class="py-3 px-4 w-full border border-gray-300 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500">{{ $informasi->deskripsi_informasi }}</textarea>
                </div>
