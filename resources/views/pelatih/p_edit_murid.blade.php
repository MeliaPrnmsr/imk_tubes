...
@section('content')
<div class="mt-4 mb-6">
    <h1 class="text-4xl font-bold">Edit Murid</h1>
</div>
<div class="p-6 border border-black rounded-md">
    ...
    <form action="{{ route('updatemurid', $data->kode_murid) }}" method="POST">
        ...
        <div class="grid grid-cols-1 gap-4">
            ...
            <div>
                <label class="font-semibold text-black">No Telepon</label>
            ...
            <div>
                <label class="font-semibold text-black">Status Aktif</label>
                <select name="status"
                    class="w-full border border-gray-300 rounded-lg py-2 px-4 mt-1 hover:border-red-700 focus:outline-none focus:ring-2 focus:ring-red-700">
